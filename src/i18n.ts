...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'download.source': 'O <a href="https://github.com/AngoZero/portkill" target="_blank" rel="noopener">compilar desde el código fuente en GitHub</a>',
