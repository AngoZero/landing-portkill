...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'hero.title': 'Mata puertos<br/>rogue.<br/>Desde tu menu bar.',
  ...
  en: {
    'meta.title': 'PortKill — Kill rogue ports. From your menu bar.',
    ...
    'meta.og.title': 'PortKill — Kill rogue ports. From your menu bar.',
    ...
    'hero.title': 'Kill rogue ports.<br/>From your menu bar.',
